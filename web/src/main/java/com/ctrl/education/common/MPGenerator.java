...
public class MPGenerator {
    ...
    public static void main(String[] args) {
       ...
       gc.setAuthor("ctrl");
        ...
        dsc.setUrl("jdbc:mysql://47.92.97.133:3306/jn_qljt?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false");
        ...
        // 修改成自己需要的表
        strategy.setInclude(new String[]{"qz_users"}); // 需要生成的表,多个表逗号隔开
